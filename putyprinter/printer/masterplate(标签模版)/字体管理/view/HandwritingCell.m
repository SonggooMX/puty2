...
- (void)awakeFromNib {
    ...
    select = [[UIButton alloc]initWithFrame:CGRectMake(SCREEN_WIDTH-50, 14.5, 15, 15)];
    [select setImage:[UIImage imageNamed:@"checked_mark_nor_grey"] forState:UIControlStateNormal];
...
-(void)resetModel:(HandwritingModel *)model
